...
#align ils data
/userdata/arup/miniconda3/bin/java -Xmx50G -jar tools/gatk/GenomeAnalysisTK.jar -T UnifiedGenotyper -nt 26 -I dedup/merged_ils.bam -R reference/h37rv.fasta -o variants/gatk_call.vcf -glm SNP
